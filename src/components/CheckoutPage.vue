      ...
      <div class="first-column">
        <form>
          ...
          <div class="shipping-address-div">
            ...
            <div
              class="div-inputsAddress"
              id="new-address-form"
              v-show="inputsAddressVisible"
            >
              <input
                type="text"
                id="name"
          ...
          <div class="shipping-address-div">
            ...
            <div class="payment-checkout-form">
              ...
              <ul class="shipping-method-ul">
                <li
                  class="shipping-method-li"
                  v-if="selectedState === 'Beirut Governorate'"
                >
                  <input
                    type="radio"
                ...
                >
                  ...
                  <label for="shipping-method-2"
                    >Same day delivery (Beirut) - $6.00</label
                  >
                </li>
          ...
          <div class="final-checkout">
            ...
            >
            <button class="btn-finalcheckout" @click="checkout">
              Checkout
            </button>
          </div>
        </form>
            ...
            <div :class="{ hidden: !couponFieldVisible }">
              <div class="cc-div">
                ...
                <button
                  @click="applyCoupon"
                  id="apply-button"
                  class="button-coupon-code"
                >
                  <i class="fa-solid fa-gift"></i>
                  Apply
                </button>
              </div>
              <p v-if="invalidCouponCode" class="invalid">
...
export default {
  ...
  methods: {
        ...
        if (response.status === 200) {
          ...
          if (response.data && response.data.data.value) {
            ...
            const discount = parseFloat(
              (this.subtotal * (discountPercentage / 100)).toFixed(2)
            );
    ...
    checkout() {
      ...
      if (this.invalidCouponCode === false) {
        const orderData = {
          products: products,
...
.add-new-address, .choose-country {
  width: 100%;
