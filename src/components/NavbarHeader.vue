<template>
        ...
        <ul class="nav-links mobile-menu" :class="{ 'mobile-menu-show': showMobileMenu }">
            ...
            <div>
                ...
                <div class="two-buttons">
                    <router-link to="/login" class="btn-log" @click="toggleMobileMenu"
                        v-show="showMobileMenu">LOGIN</router-link>
                    <router-link to="/register" class="btn-reg" @click="toggleMobileMenu"
                        v-show="showMobileMenu">REGISTER</router-link>
                </div>
            </div>
    ...
    <nav class="desktop-nav" v-else>
        <div class="navbar">
            ...
            <div class="cart-wish">
                <li class="cart-icon"><a href="#" @click="toggleFilterMenu"><i
        ...
        <div class="card">
            <ul class="card-ul">
                <a v-for="subcategory in subcategories" :key="subcategory.id" class="card-li"
                    @click="navigateToSubcategory(subcategory.name)">
                    {{ subcategory . name }}
                </a>
            </ul>
        </div>
...
<style scoped>
    ...
    .mobile-menu-show {
        right: 0;
        /* Slide the menu into view when active */
    }
    ...
    .subcategories-card {
        ...
        /* Center vertically */
        flex-wrap: wrap;
        /* Allow subcategories to wrap onto multiple rows */
        margin-top: 20px;
        /* Adjust as needed */
    }
    ...
    .card-li {
        margin: 5px;
        /* Adjust spacing between subcategories */
        padding: 5px 10px;
