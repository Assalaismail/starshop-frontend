        ...
        <div class="table-div">
            <table class="table-cart">
                ...
                <tr v-for="(item, index) in cart" :key="index" class="table-tr">
                    <td><img :src="item.image" alt="Cart Item Image" class="cart-image" /></td>
                    <td class="cart-name">{{ item . name }}<p class="cart-size-color"> (<span>Size:</span>
                            {{ item . size }}, <span>Color:</span> {{ item . color }})</p>
                    </td>
                    ...
                    <td class="btn-trash" @click="removeFromCart(index)"><i class="fa-solid fa-trash-can"></i></td>
